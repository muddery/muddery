...
"""{b=============================================================={n
  ...
  这是一款很小的单人游戏，游戏情节很短，仅用于展示 Muddery 系统的特性。由于会不定期地更改游戏代码及数据库结构，{r用户的游戏进度、数据可能会部分或全部丢失{n，敬请谅解。
 
  Muddery 是一个用Python编写的开源的在线文字游戏框架，更多信息欢迎访问我们的网站 {whttp://www.muddery.org/cn{n 以获取更多信息 。
{b=============================================================={n"""
