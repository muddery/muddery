...
class TypesMapper(object):
    """
    This model deals the world data's types.
    """
    def __init__(self):
        self.objects = apps.get_model(settings.WORLD_DATA_APP, "types").objects
        self.all_tables = []
    ...
    def get_field_types(self, table, field):
        """
        Get types used in the specified table and field.
        """
        return self.objects.filter(table=table, field=field)
        
    def get_all_tables(self):
        """
        Get all talbes that have type fields.
        """
